...
amo_neg_250 <- read_csv("Synthetic_data/Neg_250_years_CONUS.csv", col_names = FALSE)
...
load("amo_all_250_clean_get_grid_alt_date_CONUS.rda")
load("amo_neg_250_clean_get_grid_alt_date_CONUS.rda")
load("amo_pos_250_clean_get_grid_alt_date_CONUS.rda")
...
coastlines <- read.xlsx("coastline-counties-list.xlsx", colNames = TRUE, startRow = 3) %>% clean_names()
