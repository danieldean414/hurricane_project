...
load('02_code//modobj.RData') # why were there 2 versions of modobj??

# Seeing if I can fix this latest issue with an older version of Hmisc?
...
#packageurl <- "https://cran.r-project.org/src/contrib/Archive/Hmisc/Hmisc_4.1-1.tar.gz"
  # not super optimistic, but trying an older version
    # I'd be suprised if I installed this before 2020ish, so presumably something else after all...
#install.packages(packageurl, repos=NULL, type="source") # do I need to 'name' it?
